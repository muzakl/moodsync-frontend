            ...
            <div className={classes.introHolder}>
                ...
                <div className={classes.cardsWrapper}>
                    <div className={classes.card}>
                        ...
                        <p>Describe your mood or activity and let our AI create the perfect playlist just for you</p>
                    </div>
                    <div className={classes.card}>
                    ...
                    <div className={classes.infoHolder}>
                        ...
                        <div className={classes.instructionWrapper}>
                            ...
                            <div className={classes.textWrapper}>
                                ...
                                <p>Our AI will generate a custom playlist that matches your description perfectly</p>
                            </div>
                        </div>
                    </div>
                </div>
